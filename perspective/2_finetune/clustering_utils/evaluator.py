...
DEFINITIONS = {
    ...
    'hkunlp/instructor-large': {
        ...
        'biorxiv-clustering-s2s': 'Represent the biomedical statement for retrieval: ',
        'medrxiv-clustering-s2s': 'Represent the medicine statement for retrieving duplicate sentences: ',
        'ArxivClusteringP2P': 'Represent the science passage for retrieval: ',
        'arxiv-clustering-s2s': 'Represent the science statement for retrieval: ',
        'BiorxivClusteringP2P': 'Represent the Bio-medicine passage for retrieval: ',
        'MedrxivClusteringP2P': 'Represent the medicine paragraph for retrieval: ',
        'reddit-clustering': 'represent a reddit community title: ',
        'reddit': 'represent a reddit community title: ',
        'RedditClusteringP2P': 'represent a Reddit community passage: ',
        'stackexchange-clustering': 'Represent the question for retrieval: ',
